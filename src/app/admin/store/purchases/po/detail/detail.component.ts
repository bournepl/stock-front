...
export class DetailComponent {
  ...
  onPrint(id: string) {
    this.router.navigate(['/admin/store/purchases/po/print', id]);
  }
  ...
  onCreateRi(id: any) {
    ...
    this.router.navigate(['/admin/store/purchases/ri/add', id]);
  ...
  onRouter(value: string) {
    ...
    this.prService.findPrByPrId(this.token.getUser().admin, value).subscribe({
      next: (data) => {
        this.router.navigate(['/admin/store/purchases/pr/detail', data.id]);
      },
    });
