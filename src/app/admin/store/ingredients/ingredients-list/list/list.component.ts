...
export class ListComponent {
  ...
  onInformation(id: any) {
    this.router.navigate(["/admin/store/ingredients/ingredients-list/edit", id]);
  }

  onDetail(id: any) {
    this.router.navigate(["/admin/store/ingredients/ingredients-list/detail", id]);
  }
  ...
  onAdd() {
    this.router.navigate(['/admin/store/ingredients/ingredients-list/add']);
  }
