...
@Component({
  selector: 'app-use-stock',
  templateUrl: './use-stock.component.html',
  styleUrl: './use-stock.component.scss'
})
export class UseStockComponent {
  ...
  fileNameExport = 'UseStockSheet.xlsx';
  ...
  retrieveStock() {
    ...
    this.inventoryService.getAllUse(this.token.getUser().uniqueKey, this.token.getBranchId(), params)
      .subscribe({
        next: (data) => {
